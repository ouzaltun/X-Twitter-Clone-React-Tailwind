  ...
  return (
    <div>
      <Popover className="relative">
        ...
        <Popover.Panel className="absolute z-10 w-[318px] bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
          <button className="px-4 h-14 w-full  inline-flex items-center  hover:bg-[#eff3f41a] transition-colors">
            ...
            <div className="mr-4 ml-5 text-xl font-bold">Bağlan</div>
          </button>
          <button className="px-4 h-14 w-full  inline-flex items-center  hover:bg-[#eff3f41a] transition-colors">
            <div className=" relative">
              <svg
            ...
            <div className="mr-4 ml-5 text-xl font-bold">Para kazanma</div>
          </button>
          <div className="py-2">
            <div className="w-[89%] m-auto h-[1px] bg-[#2f3336]"></div>
          </div>
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="h-[52px] flex justify-between w-full items-center px-4 text-[##e7e9ea] font-bold hover:bg-[#eff3f41a] transition-colors">
                  İçerik Üreticisi Stüdyosu
                  <svg
                    className={classNames("", {
                      "rotate-180 text-[#1a8cd8] duration-100": open,
                    })}
                    viewBox="0 0 24 24"
                    height={18.25}
                    width={18.25}
                    fill="currentColor"
                    aria-hidden="true"
                    class="r-1nao33i r-4qtqp9 r-yyyyoo r-1xvli5t r-19u6a5r r-dnmrzs r-bnwqim r-1plcrui r-wfqgy4 r-lrvibr"
                ...
                <Disclosure.Panel className="">
                  <Link
                    to="/"
                    className="w-full px-3 flex gap-3 items-center text-[##e7e9ea] font-medium text-[15px] h-11"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      height={18.25}
          ...
          <Disclosure>
            {({ open }) => (
              <>
                ...
                <Disclosure.Panel className=" hover:bg-[#eff3f41a] transition-colors">
                  <Link
                    to="/"
                    className="w-full px-3 flex gap-3 items-center text-[##e7e9ea] font-medium text-[15px] h-11"
                  >
